export const RESUME_DATA = {
  ...
  projects: [
    {
      ...
      description: "Developed a comprehensive market expansion strategy for DAAR Communications, resulting in a 15% increase in market share over two years.",
      category: "Marketing Strategy"
    },
    {
      title: "Digital Marketing Transformation",
      description: "Led the transition of traditional advertising to multi-channel digital campaigns, optimizing ROI and audience engagement.",
      category: "Digital Marketing"
    },
    {
      title: "Strategic Partnerships Program",
      description: "Negotiated and managed key relationships with broadcast partners and corporate sponsors to increase revenue streams.",
  ...
  testimonials: [
    {
      content: "Suleiman's strategic approach to marketing transformed our brand visibility. His over 20 years of experience is evident in every campaign he leads.",
      name: "Ahmed Musa",
      title: "Regional Director",
      company: "Abuja Business Forum"
    },
    {
      content: "A results-oriented professional who understands the intersection of retail and digital marketing. Suleiman is a rare talent in the industry.",
      name: "Blessing Okeke",
      title: "Head of Growth",
      company: "Lagos Tech Hub"
    },
    {
      content: "Hardworking, visionary, and a great team leader. Suleiman doesn't just manage projects; he inspires excellence in everyone involved.",
      name: "Chidi Okafor",
      title: "CEO",
      company: "Strategic Media Ltd"
    }
  ]
};
